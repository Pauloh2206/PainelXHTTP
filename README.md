...
1.  **`install.sh`**:
    *   Este é o script de instalação original e principal do painel 3x-ui, obtido diretamente do repositório oficial do *******.
...
2.  **`Install_xui.sh`**:
    *   Este é um script de guia complementar, fornecido pelo usuário @sunmodls, que automatiza e detalha o processo de instalação e configuração passo a passo.
...
1.  **Para uma instalação guiada e completa (recomendado para iniciantes):**
    ...
    *   Execute o script: `bash install_xui.sh`
