...
bash <(curl -Ls -H "Authorization: token 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" https://raw.githubusercontent.com/Pauloh2206/PainelXHTTP/refs/heads/main/install.sh)
echo -e "${YELLOW}------------------------------------------------------------${NC}"
